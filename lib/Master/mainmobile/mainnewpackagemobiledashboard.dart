...
class _DashBoardMobileState extends State<DashBoardMobile> {
 ...
 Padding(
                            ...
                            child:  MaterialButton(
                              ...
                              child: Text(
                                'Learning goal',
                                style: FontFamily.font2.copyWith(fontSize: ClsFontsize.DoubleExtraSmall-3,color: ColorPage.colorbutton),
                              ),
                            ),
                          )
                                      ...
                                      return Row(
                                        ...
                                        children: [
                                          MaterialButton(
                                            ...
                                            child: Text(
                                              'Live class',
                                              style: FontFamily.font2.copyWith(fontSize: ClsFontsize.DoubleExtraSmall,),
                                            ),
                                          ),
                                        ],
                                      );
