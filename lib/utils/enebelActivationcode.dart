    ...
    Alert(
      ...
      buttons: [
        DialogButton(
          ...
          onPressed: () { Get.back(); confirmActivationCode(context);
            ...
            children: [
              ...
              SizedBox(height: 20,),
               Row( mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                Expanded(child: Container(height: 2,color: ColorPage.appbarcolor,)),
              ...
              Row(children: [Expanded(child: Container(height: 200,color: ColorPage.bluegrey300,child: Center(child: Text("Package Contents"),),))],)
